              ...
              $create_user =  User::updateOrcreate([
               ...
               if (isset($driver_profile['car'])){
                  ...
                  $create_car = UserCar::updateorcreate(['yandex_car_id' => $driver_profile['car']['id']],
                   [
                       'yandex_car_id' => $driver_profile['car']['id'],
                       'mark_id' =>$mark->id,
                       'model_id' => $model->id,
                       'normalized_number' => $driver_profile['car']['normalized_number'],
                       'number' => $driver_profile['car']['number'],
                       'registration_cert' => $driver_profile['car']['registration_cert'],
                       'status' => $driver_profile['car']['status'],
                       'vin' => $driver_profile['car']['vin'],
                       'year' => $driver_profile['car']['year'],
                       'callsign' => $driver_profile['car']['callsign'],
