...
@section('content')
    ...
    <div class="card card-primary" bis_skin_checked="1">
        ...
        <form action="{{route('create_faq')}}" method="post" class="forms-sample" enctype="multipart/form-data">
            @csrf
            <div class="card-body" bis_skin_checked="1">
                       <div class="form-group" bis_skin_checked="1">
                    <label for="exampleInputName1">Вопрос</label>
                    <input  required  type="text" class="form-control" id="exampleInputName1"  name="faq" value="">
                </div>

                <div class="form-group" bis_skin_checked="1">
                    <label for="exampleInputName1">Ответ</label>
                    <textarea  type="text" class="form-control" id="exampleInputName1"  name="replay" ></textarea>
                </div>
