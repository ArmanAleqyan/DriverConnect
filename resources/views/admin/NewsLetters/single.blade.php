...
@section('content')
    ...
    <div class="card card-primary" bis_skin_checked="1">
        ...
        <form action="{{route('update_letters')}}" method="post" class="forms-sample" enctype="multipart/form-data">
            @csrf
            <div class="card-body" bis_skin_checked="1">
                ...
                <input type="hidden" name="letters_id" value="{{$get->id}}">
                <div class="form-group" bis_skin_checked="1">
                    <label for="exampleInputName1">Дни</label>
                    <input     type="number" class="form-control" id="exampleInputName1"  name="day" value="{{$get->day}}">
                </div>

                <div class="form-group" bis_skin_checked="1">
                    <label for="exampleInputName1">Собшения</label>
                    <textarea     type="text" class="form-control" id="exampleInputName1"  name="message" >{{$get->message}}</textarea>
                </div>
